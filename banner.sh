...
║                         with Dokploy Deployment                             ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
EOF
    echo -e "${NC}"
    echo -e "${GRAY}Version 2.2.0 | Production Ready | MIT License${NC}"
...
# Export functions
export -f show_install_banner
export -f show_user_banner
export -f show_setup_banner
export -f show_ssl_banner
export -f show_check_banner
export -f show_success_banner
export -f show_error_banner
export -f show_progress
export -f show_section
export -f show_info_box
